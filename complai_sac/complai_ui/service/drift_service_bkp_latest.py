...
class DriftService():
    ...
    def get_ndcg_scores(self, day):
        ...
        return ndcg_score*100, overall_ndcg_score*100

    def get_baseline_feature_attribution(self):
        #baseline_data = get_shap_aggr_data(self.db, data_type='val')
        baseline_data = get_drift_aggr_data(self.db, data_type='val')
        #baseline_feature_attribution = {i['Column_Name']: i['validation_shap_aggregated'] for i in baseline_data}
        baseline_feature_attribution = {i['Column_Name']: i['validation_attribution_value'] for i in baseline_data}
